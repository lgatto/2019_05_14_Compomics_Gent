...
\date{19 November 2018 -- Louvain Drug Research Institute}

\title{ \textbf{Understanding more biology using computational
    science: \\examples from spatial proteomics} }
...
\begin{frame}[fragile]{Conclusions}
  ...
  \item Rigorous computational infrastructure and sound data analysis
    and interpretation is a long term investment.
